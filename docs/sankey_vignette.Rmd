...
# Global chunk options for the whole vignette
knitr::opts_chunk$set(
  echo = TRUE,
  warning = FALSE,
  message = FALSE,
  fig.width = 11,      # Make plots wide enough for Sankey layout
  fig.height = 6,      # Height for clear ribbon spacing
  out.width = "100%"   # Scale plots to full vignette width
)
